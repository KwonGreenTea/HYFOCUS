...
public class RootConfig {
    ...
    public DataSource dataSource() { // DataSource 빈 생성 메서드
        ...
        config.setDriverClassName("com.mysql.cj.jdbc.Driver"); // JDBC 드라이버 클래스명 설정
        config.setJdbcUrl("jdbc:mysql://localhost:3306/hyfocus?useSSL=false&serverTimezone=UTC"); // DB 접속 URL 설정
        config.setUsername("hyfocus"); // DB 계정 이름 설정
        config.setPassword("198023"); // DB 계정 비밀번호 설정
